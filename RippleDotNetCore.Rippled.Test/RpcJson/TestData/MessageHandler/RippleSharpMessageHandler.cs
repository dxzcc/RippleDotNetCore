...
using RippleDotNetCore.Rippled.Helper;

namespace RippleDotNetCore.Rippled.Tests.RpcJson.TestData.MessageHandler
{
    public class RippleSharpMessageHandler : HttpMessageHandler
    {
        ...
        {
            var assembly = Assembly.Load(new AssemblyName("1212"));
            var resourceName = $"RippleDotNetCore.Rippled.Tests.RpcJson.TestData.{method}.json";
