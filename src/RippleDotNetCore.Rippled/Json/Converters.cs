    ...
    public class LedgerNodeConverter : Newtonsoft.Json.Converters.CustomCreationConverter<ILedgerNode>
    {
        ...
        public ILedgerNode Create(Type objectType, JObject jObject)
        {
            ...
            switch (type)
            {
                ...
                default:
                    throw new Exception($"The {nameof(LedgerEntryType)} {type} is not supported!");
            }
        }
    ...
    public class TransactionConverter : Newtonsoft.Json.Converters.CustomCreationConverter<ITransaction>
    {
        ...
        public ITransaction Create(Type objectType, JObject jObject)
        {
            ...
            switch (type)
            {
                ...
                default:
                    throw new Exception($"The {nameof(TransactionType)} {type} is not supported!");
            }
        }
    ...
    public class JobTypeConverter : Newtonsoft.Json.Converters.CustomCreationConverter<IJobType>
    {
        ...
        public IJobType Create(Type objectType, JObject jObject)
        {
            ...
            switch (type)
            {
                ...
                default:
                    throw new Exception($"The {nameof(JobType)} {type} is not supported!");
            }
        }
